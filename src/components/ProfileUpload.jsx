...
const ProfileUpload = () => {
  ...
  return (
    <div className="col-span-3 rounded">
      <h1 className="text-3xl text-center text-gray-200 font-poppins">
      ...
      >
        ...
        <label
          htmlFor="avatar"
          className="relative cursor-pointer mt-4 w-full px-4 py-2 border border-gray-300 rounded text-center text-white bg-zinc-900  transition duration-300 ease-in-out"
        >
